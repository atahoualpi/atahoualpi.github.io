...
d3.csv("csv-files/best_area4.csv", function(error, data) {
    ...
    .enter().append("rect")
      ...
      .on("mouseover", function(d){
            div.transition()
              .duration(200)
              .style("opacity", .9);
              var fixed = d.Value-1000
            div.html("<span style='color:white'>Area: "+d.Area+"</br></span><span style='font-weight:bold'>"+d.Group+": </span>"+"<span style='color:green' style='font-weight:bold'>"+fixed+"</span>")
  ...
  group.filter(function(d, i) { return !i; }).append("g")
      ...
      .selectAll("text")  
            ...
            .attr("dx", "2em")
            .attr("dy", ".45em")
            .style("font-size","12px") //To change the font size of texts
  ...
  function transitionMultiples() {
    ...
    g.select(".group-label").attr("y", function(d) { return y1(d.values[0].Value / 2); })
     ...
     var mult = svg1.selectAll("rect").on("mouseover", function(d){
            div.transition()
              .duration(200)
              .style("opacity", .9);
  ...
  function transitionStacked() {
    ...
    var mult = svg1.selectAll("rect").on("mouseover", function(d){
            ...
            div.html("<span style='color:white'>Area: "+d.Area+"</br></span><span style='font-weight:bold'>Danger Level: </span><span style='color:red' style='font-weight:bold'>"+d.Scale+"</span>")
              .style("left", (d3.event.pageX) + "px")     
                      .style("top", (d3.event.pageY) + "px"); 
          })
           .on("mouseout", function(d) {       
...
g2.append("text")
      ...
      .attr("dy", "2em")
      .text(function(d) { 
        return parseFloat(d.data.Percentage).toFixed(2)+"%"; });
